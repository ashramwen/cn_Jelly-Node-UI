import {
  ...
  EventEmitter, SimpleChange, ElementRef, Renderer, NgZone
} from '@angular/core';
...
@Component({
  ...
  providers: [VALUE_ACCESSOR, CronService],
...
export class RuleCron extends JNEditorFormControl {
  ...
  private change() {
    setTimeout(() => {
      this.value = this.cronService.generateCron(this);
    });
  }

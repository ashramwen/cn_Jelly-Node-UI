...
export const EXTERNAL_INFO_PANEL_COMPONENTS = [ChartNodeInfoPanelModel, BucketNodeInfoPanelModel, MetricNodeInfoPanelModel, ExtendNodeInfoPanelModel, DrilldownNodeInfoPanelModel, SubChartNodeInfoPanelModel];

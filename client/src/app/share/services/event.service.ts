...
export const NODE_EVENTS = {
  ...
  SELECTION_BEFORE_MOVED: 'NODE_BEFORE_MOVED',
  SELECTION_BEFORE_REMOVED: 'NODE_BEFORE_REMOVED',
  NODE_BEFORE_ADDED: 'NODE_BEFORE_ADDED',
  NODE_BEFORE_LINKED: 'NODE_BEFORE_LINKED',
  NODE_BEFORE_CHANGED: 'NODE_BEFORE_CHANGED',
  LINK_BEFORE_REMOVED: 'LINK_BEFORE_REMOVED'
};

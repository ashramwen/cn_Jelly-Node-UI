var assert = require('assert')
    // dataParserService = require('../../api/services/DataParserService.js');
...
describe('Data Parser Service', function() {
  ...
  it('should convert interesting rule', function() {
    DataParserService.toRulesEngine(dataParserServiceTestInput1, function(result) {
    	assert(result, dataParserServiceTestExpected1)
    })
  });

  it('should convert soso rule', function() {
  	DataParserService.toRulesEngine(dataParserServiceTestInput2, function(result) {
  		assert(result, dataParserServiceTestExpected2)
  	})
  })
});